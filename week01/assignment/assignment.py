...
def run_with_threads(tur, log, main_turtle):
    ...
    # t_all = [draw_squares(tur),
    #          draw_circles(tur),
    #          draw_triangles(tur),
    #          draw_rectangles(tur)]
    t_all = [threading.Thread(target=draw_squares, args=[tur]),
             threading.Thread(target=draw_circles, args=[tur]),
             threading.Thread(target=draw_triangles, args=[tur]),
             threading.Thread(target=draw_rectangles, args=[tur])
             ]
    threads = []
