...
class Feeder(threading.Thread):
    def __init__(self,
                 ...
                 table_queue,
                 table_lock,
                 feeder_barrier: threading.Barrier,
                 number_of_eaters):
        ...
        self.feeder_barrier = feeder_barrier
    ...
    def run(self):
        ...
        #print(f'thread {self} done, waiting...')
        self.feeder_barrier.wait()
...
def main(number_of_eaters, number_of_feeders):
    ...
    feeder_barrier = threading.Barrier(number_of_feeders)

    # create feeders
    feeders = []
    for i in range(number_of_feeders):
        feeders.append(
            Feeder(i, sem_mouth_full, sem_can_I_eat, table_queue, table_lock, feeder_barrier, number_of_eaters))
...
if __name__ == '__main__':
    ...
    # run with different number of eaters/feeders
